        ...
        for index in range(len(postags)):
            ...
            if postags[index] == 'v' and words[index]=='是':
                ...
                if 'SBV' in child_dict and 'VOB' in child_dict:
                    ...
                    #如果主语是代词的话
                    if A=='' or postags[Aindex]=='r' or A.find('什么')!=-1 or A.find('哪')!=-1 :
                        result['pron'][0]=True
                        #out_file.write('\twarning:主语为代词，该三元组缺失主语')
                    if C=='' or postags[Cindex]=='r' or C.find('什么')!=-1 or C.find('哪')!=-1 :
                        result['pron'][2]=True
            ...
            if postags[index] == 'v':
                ...
                if 'SBV' in child_dict:
                    if 'VOB' in child_dict:
                        ...
                        #out_file.write("%s\t(%s, %s, %s)" % (sentence,A, B, C))
                        #如果主语是代词的话
                        if postags[Aindex]=='r' or A.find('什么')!=-1 or A.find('哪')!=-1 :
                            result['pron'][0]=True
                            #out_file.write('\twarning:主语为代词，该三元组缺失主语')
                        if postags[Cindex]=='r' or C.find('什么')!=-1 or C.find('哪')!=-1 :
                            result['pron'][2]=True
                            #out_file.write('\twarning:属性值为代词，该三元组缺失属性值')
                        #out_file.write('\n')
                        if result['pron'][0] and result['pron'][2]:
